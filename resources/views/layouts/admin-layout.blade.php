...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{ URL::asset('./adminlte/css/bootstrap.min.css') }}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ URL::asset('./adminlte/css/font-awesome.min.css')}}">
  <!-- Ionicons -->
...
<!-- SlimScroll -->
<script src="{{ URL::asset('./adminlte/js/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick -->
<script src="{{URL::asset('/adminlte/js/fastclick/lib/fastclick.js')}}"></script>
<!-- AdminLTE App -->
